  ...
  return (
    <div className="collection">
      <div className="collection_heading">
        <p data-aos="fade-down">Collection</p>
        <h3 data-aos="fade-up">Our Artisanal Showcase</h3>
      </div>
      <div className="collection_content">
        <div data-aos="zoom-in" className="collection_content_box">
          <img src={collection_image1} />
          <h2>Luxury Accessories</h2>
          <p>
            Discover the enduring elegance of bronze jewelry, a harmonious
            fusion of warmth and artisanal craftsmanship.
          </p>
          <a href="#">Explore</a>
        </div>
        <div data-aos="zoom-in" className="collection_content_box">
          ...
          <h2>Bamboo & Cane</h2>
          <p>
            Embrace the artistry of bamboo and cane handicrafts, where natural
            materials & craftsmanship unite in perfect harmony.
          </p>
          <a href="#">Explore</a>
        </div>
        <div data-aos="zoom-in" className="collection_content_box">
          ...
          <h2>Dhokra Metal</h2>
          <p>
            Admire the intricacy of metal crafts, where age-old techniques meet
            masterful artistry in stunning metallic creations.
          </p>
          <a href="#">Explore</a>
        </div>
        <div data-aos="zoom-in" className="collection_content_box">
          ...
          <p>
            Delight in the vibrant charm, a testament to the seamless interplay
            of intricate needlework and vivid creativity.
          </p>
          <a href="#">Explore</a>
        </div>
        <div data-aos="zoom-in" className="collection_content_box">
          ...
          <p>
            Where ancient cultural heritage blends with unique, earthy designs
            to create truly enchanting adornments.
          </p>
          <a href="#">Explore</a>
        </div>
        <div data-aos="zoom-in" className="collection_content_box">
      ...
      <div className="collection_featured">
        <h1 data-aos="fade-right">We are featured on</h1>
        <img data-aos="fade-up" src={collection_amazon} />
        <img data-aos="fade-down" src={collection_etsy} />
        <img data-aos="fade-left" src={collection_craftindika} />
      </div>
    </div>
  );
};
